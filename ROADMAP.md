...
| F‑040 | Natural‑language policy editor (Phase 1: heuristic + optional LLM `POST /v1/governance/policy/translate`, natural-language mode on `/governance`) | Pro | P1 | ✅ Phase 1 | api/web | 2026‑11 | M5 |
